// this seed.js file is to essentially add dummy data to the database that is mongoDB.

import mongoose from 'mongoose';
import dotenv from 'dotenv';
import bcrypt from 'bcryptjs';
// ⚠️ Crucial for ES Modules: Added the explicit .js extension on your relative paths
...
const seedDatabase = async () => {
    try {
        // Safe check for the correct .env naming pattern we initialized earlier
        const dbURI = process.env.MONGODB_URI || process.env.MONGO_URI || 'mongodb://localhost:27017/eventora';
        ...
        // Hash user passwords using standard async/sync pairing pattern
